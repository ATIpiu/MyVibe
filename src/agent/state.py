...
class AgentState:
    ...
    # 索引工具调用追踪（统计本会话中 read_file 实际注入上下文的量）
    memory_tool_calls: int = 0
    memory_tool_tokens: int = 0
    # read_file(scope='function') dedup 缓存：key=function_key, value=调用时间戳
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "read_file_cache": self.read_file_cache,
        }
    ...
    def from_dict(cls, data: dict) -> "AgentState":
        ...
        state.read_file_cache = data.get("read_file_cache", {})
        return state
